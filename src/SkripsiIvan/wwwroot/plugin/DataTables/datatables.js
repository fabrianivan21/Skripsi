 ...
 *   https://datatables.net/download/#bs/dt-1.10.16/fh-3.1.3/rg-1.0.2/sl-1.2.3
 *
 * Included libraries:
 *   DataTables 1.10.16, FixedHeader 3.1.3, RowGroup 1.0.2, Select 1.2.3
 */
...
(function( $, window, document, undefined ) {
	...
	_api_register( 'row()', function ( selector, opts ) {
		return _selector_FirstOrDefault( this.rows( selector, opts ) );
	} );
	...
	_api_register( 'column()', function ( selector, opts ) {
		return _selector_FirstOrDefault( this.columns( selector, opts ) );
	} );
	...
	_api_register( 'cell()', function ( rowSelector, columnSelector, opts ) {
		return _selector_FirstOrDefault( this.cells( rowSelector, columnSelector, opts ) );
	} );
	...
	DataTable.ext = _ext = {
		 ...
		 *  @type string
		 */
		build:"bs/dt-1.10.16/fh-3.1.3/rg-1.0.2/sl-1.2.3",
